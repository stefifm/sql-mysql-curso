CREATE DEFINER=`root`@`localhost` PROCEDURE `comparacion_ventas_case`(vfecha1 DATE, vfecha2 DATE)
BEGIN
...
-- con case
CASE
WHEN variacion > 10 THEN SET vresultado = 'Verde';
WHEN variacion >= -10 AND variacion < 10 THEN SET vresultado = 'Amarillo';
WHEN variacion < -10 THEN SET vresultado = 'Rojo';
END CASE;
