...
-- -----------------------------------------------------
-- Table `ventas_jugos`.`tb_facturas_gral`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_facturas_gral` (
  `NUMERO` VARCHAR(5) NOT NULL,
  `FECHA` DATE NULL DEFAULT NULL,
  `DNI` VARCHAR(11) NOT NULL,
  `MATRICULA` VARCHAR(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ventas_jugos`.`tb_items_facturas` (
  ...
  CONSTRAINT `FK_FACTURAS`
    FOREIGN KEY (`NUMERO`)
    REFERENCES `ventas_jugos`.`tb_facturas_gral` (`NUMERO`),
